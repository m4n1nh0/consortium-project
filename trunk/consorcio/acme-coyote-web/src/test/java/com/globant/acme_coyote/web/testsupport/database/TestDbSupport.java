...
package com.globant.acme_coyote.web.testsupport.database;
...
import com.globant.acme_coyote.web.testsupport.SpringTestUtils;
...
public class TestDbSupport extends TestCase {
   ...
   */
  private static String testMarker = "acme_coyote_marker_666";
